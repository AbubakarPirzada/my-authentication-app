		...
		if (error) {
			switch (error) {
				...
				case 'verification_token_expired':
					errorMessage = 'Your verification link has expired. Please register again to receive a new one.';
					break;
				case 'user_not_found':
				...
				case 'CredentialsSignin':
					errorMessage = 'Invalid email or password. If you recently registered, please verify your email first.';
					break;
				default:
			...
			{#if showVerificationSuccess}
				<div class="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl backdrop-blur-sm">
					<div class="flex">
						...
						<div class="ml-3">
							<h3 class="text-sm font-medium text-emerald-300">Email Verified!</h3>
			...
			{#if errorMessage}
				<div class="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl backdrop-blur-sm">
					<div class="flex">
						...
						<div class="ml-3">
							<h3 class="text-sm font-medium text-red-300">Sign In Error</h3>
